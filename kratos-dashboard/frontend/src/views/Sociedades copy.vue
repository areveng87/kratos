<template>
  <Sidebar>
    ...
    <main class="flex-1 overflow-y-auto main-content p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option v-for="fondo in fondos" :key="fondo.idrepresen" :value="fondo.idrepresen">
                {{ fondo.descripcion }}
              </option>
            </select>
          </div>
      ...
      >
        <template #fondo_nombre="{ row }">
          <div class="text-center">
            <span v-if="row.fondo_nombre" class="text-gray-200">
              {{ row.fondo_nombre }}
            </span>
...
const totalItems = computed(() => filteredSociedades.value.length)
